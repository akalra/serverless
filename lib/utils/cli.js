...
exports.generateMainHelp = function(allCommands, loadedPluginNames) {
  ...
  let projectPluginNames = _.reject(loadedPluginNames, function(name) { return _.startsWith(name, "serverless.core") });
  console.log(chalk.dim("Project-specific plugins loaded: %s"), projectPluginNames.join(', '));
